...
script.src = loc + "/BALADYCDN/Content/Support.js?v=" + counttt + "";
...
linkCss.setAttribute("href", loc + "/BALADYCDN/Content/enhancement.css?v=" + counttt + "");
...
if (getUrlQueryStringParameters("baladybusiness")) {
    ...
    linkCss.setAttribute("rel", "stylesheet");
    linkCss.setAttribute("type", "text/css");
    linkCss.setAttribute("href", loc + "/BALADYCDN/Content/BaladyBusiness/BaladyBusinessUI.css?v=" + counttt + "");
